...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    function uploadFile($file, $uploadDir) {
     ...
     $documents_files = json_encode([
        'consentFile' => uploadFile('consent_obtain_other_upload', $uploadDir) !== null 
            ? uploadFile('consent_obtain_other_upload', $uploadDir) 
            : $_POST['consent_obtain_other_upload_already'],
    
        'mouFile' => uploadFile('MoU_upload', $uploadDir) !== null 
            ? uploadFile('MoU_upload', $uploadDir) 
            : $_POST['MoU_upload_already'],
    
        'Proposal_pdf_copy' => uploadFile('Proposal_pdf_copy', $uploadDir) !== null 
            ? uploadFile('Proposal_pdf_copy', $uploadDir) 
            : $_POST['Proposal_pdf_copy_already'],
    
        'ctri_request_upload' => uploadFile('ctri_request_upload', $uploadDir) !== null 
            ? uploadFile('ctri_request_upload', $uploadDir) 
            : $_POST['ctri_request_upload_already']
    ]);
