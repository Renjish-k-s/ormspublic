...
if (!isset($_SESSION['user_id']) || $_SESSION['user_id'] == -1) {
    header("Location: error403.php"); // Redirect to custom error page
...
<li class="nav-item">
    ...
    <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="./track_scientific_application.php" id="">Track application</a>
        </div>
    </div>
</li>
    ...
    <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo">
        <div class="bg-white py-2 collapse-inner rounded">
         ...
         <?php } elseif($user['status']!='1')
         {
                    ...
                    echo "<script>
                        setTimeout(() => {
                            window.location.href = './update_user/'; // Change 'success.php' to your desired page
                        }, 500);
                    </script>";
                    exit;
