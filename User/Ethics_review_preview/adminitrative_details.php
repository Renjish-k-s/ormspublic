            ...
            <h2 class="text-center">ADMINISTRATIVE DETAILS</h2>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="qualification_gain">What degree will you get after this research?<i title="What academic degree or qualification do you aim to achieve upon the completion of this research and course?"> ℹ️</i><button type="button" class="more_info_class" ></button></label>
