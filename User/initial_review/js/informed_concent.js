...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const signed_consent_status = document.getElementById('signed_consent_status');
    const consent_obtain_other_display = document.getElementById("consent_obtain_other_display");

    if (consent_obtain_other_display && signed_consent_status) {
        signed_consent_status.addEventListener('change', function () {
            consent_obtain_other_display.style.display = this.checked ? 'block' : 'none';
        });
    }
