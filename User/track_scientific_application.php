...
<div style="max-width: 1000px; margin: 20px auto; padding: 20px; overflow-x: auto;">
    ...
    ">
        ...
        <tbody>
            ...
            $query = "SELECT * FROM application_table where user_id=$userid;";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ( $row['applicant_id_sc']==null) {
               
                echo "<td style='padding: 10px;'>Not yet generated</td>";
                }else
                {
                    echo "<td style='padding: 10px;'>" . $row['applicant_id_sc'] . "/0" . sprintf("%02d", $row['applicant_id_sc_co']) . "</td>";

                }
                $slno++;

                echo "<td style='padding: 10px;'><a href='./assessment_veiwer.php?id=" . $row['id'] . "' style='color: blue; text-decoration: underline;'>View reviews</a></td>";

                if ($status==null) {
                    echo "<td style='padding: 10px;'><a href='./scientific_review_preview/?id=" . $row['id'] . "' style='color: blue; text-decoration: none;'>view application</a></td>";
                ...
                {
                    echo "<td style='padding: 10px;'><a href='./scientific_review_preview/?id=" . $row['id'] . "' style='color: blue; text-decoration: none;'>view application</a></td>";
                echo "<td style='padding: 10px;'>Confirmed by applicant</td>";
